...
<script>
    ...
    export default {
        ...
        methods: {
            getData() {
                axios.get(this.Global.HOST+'/envs/?size=2').then(
                    res => {
                        console.log(res);
            ...
            handleDelete(index, row) {
                ...
                this.$confirm('确定要删除吗？', '提示', {
                    ...
                    .then(() => {
                        axios.delete(this.Global.HOST+'/envs/' + row.id).then(res => {
            ...
            saveEdit() {
                ...
                axios.put('http://127.0.0.1:9000/envs/' + this.form.id + '/', this.data)
                    .then(res => {
            ...
            handlePageChange(val) {
                ...
                axios.get('http://127.0.0.1:9000/envs/?size=2&page=' + val).then(res => {
                    console.log(res);
                    this.tableData = res.data.results;
                })
