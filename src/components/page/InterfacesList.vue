    ...
    <div>
        <div class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item>
                    <i class="el-icon-lx-cascades"></i> 接口列表
                </el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="container">
        ...
        <el-dialog title="编辑" :visible.sync="editVisible" width="30%">
            <el-form ref="form" :model="form" label-width="100px">
                ...
                <el-form-item label="测试人员" style="margin-bottom: 20px">
...
<script>
    ...
    export default {
        ...
        methods: {
            getData() {
                axios.get(this.Global.HOST + '/interfaces/?size=2').then(
                    res => {
                        console.log(res);
            ...
            handleDelete(index, row) {
                ...
                this.$confirm('确定要删除吗？', '提示', {
                    ...
                    .then(() => {
                        axios.delete(this.Global.HOST + '/interfaces/' + row.id).then(res => {
            ...
            saveEdit() {
                ...
                this.data = {
                    ...
                    "project_id": this.tableData[this.idx].project_id,
                    "desc": this.tableData[this.idx].desc,
                };
                axios.put(this.Global.HOST + '/interfaces/' + this.form.id + '/', this.data)
                    .then(res => {
            ...
            handlePageChange(val) {
                ...
                axios.get(this.Global.HOST + '/interfaces/?size=2&page=' + val).then(res => {
                    console.log(res);
                    this.tableData = res.data.results;
                })
