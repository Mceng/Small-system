    ...
    <div>
        ...
        <div class="container">
            ...
            >
                ...
                <el-table-column prop="name" label="所属接口"></el-table-column>
                <el-table-column prop="author" label="编写人员"></el-table-column>
...
<script>
    ...
    export default {
        ...
        methods: {
            getData() {
                axios.get('http://127.0.0.1:9000/testcases/?size=2').then(
                    res => {
                        console.log(res);
            ...
            handleDelete(index, row) {
                ...
                this.$confirm('确定要删除吗？', '提示', {
                    ...
                    .then(() => {
                        axios.delete('http://127.0.0.1:9000/testcases/' + row.id).then(res => {
            ...
            saveEdit() {
                ...
                axios.put('http://127.0.0.1:9000/testcases/' + this.form.id + '/', this.data)
                    .then(res => {
            ...
            handlePageChange(val) {
                ...
                axios.get('http://127.0.0.1:9000/testcases/?size=2&page=' + val).then(res => {
                    console.log(res);
                    this.tableData = res.data.results;
                })
