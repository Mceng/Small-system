    ...
    <div class="debugtalk">
        ...
        <el-form :inline="true" class="demo-form-inline search-style" size="small">
            <el-form-item label="选择项目">
                <el-select v-model="value" filterable @change="getfun" placeholder="请选择项目"
            ...
            <!--</el-autocomplete>-->
            <!--<el-button-group>-->
            <!--&lt;!&ndash;<el-button type="success" @click.native="findFunc()" size="small">读取</el-button>&ndash;&gt;-->
            <!--&lt;!&ndash;<el-button type="primary" @click.native="createFunc()" size="small">创建</el-button>&ndash;&gt;-->
            <!--&lt;!&ndash;<el-button type="danger" @click.native="removeFunc()" size="small">删除</el-button>&ndash;&gt;-->
            <!--</el-button-group>-->
            <!--</el-form-item>-->
...
<script>
    export default {
        ...
        methods: {
            ...
            getfun() {
                // 获取Debugtalk文件
                this.$axios.get(this.$api.Debugtalk + this.value)
                    .then(res => {
                        this.funcData = res.data['debugtalk'];
                    })
            },
            saveFunc() {
                if (!this.funcData) {
                ...
                this.$axios.put(this.$api.Debugtalk + this.value + '/', {
                    'debugtalk': this.funcData,
                    'id': this.value
                }).then((response) => {
            ...
            // },
            // removeFunc() {
            //     this.$axios.post('/v1/interfacefunc/remove', {'funcName': this.comparator}).then((response) => {
            //             this.comparator = '';
            //             this.messageShow(this, response);
            //             this.getFuncAddress()
            //         }
            ...
            // },
            getFuncAddress() {
                this.$axios.get(this.$api.Debugtalk).then((response) => {
            ...
            checkFunc() {
                ...
                this.$axios.post(this.$api.getfun, {
